        ...
        <div className="mx-auto w-full max-w-5xl px-4 py-4">
          <div className="flex h-full w-full flex-wrap items-center justify-center gap-2 text-[#626262] sm:gap-5 lg:justify-between">
            <p className="font-ovo text-center text-[16px] capitalize">
              © 2025 Syed Mahamudul Hassan. All rights reserved.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-md border border-gray-200 p-1.5 transition-all duration-300 ease-in-out hover:bg-gray-100 hover:shadow-lg">
                <Link
                  href={"https://www.linkedin.com/in/syedmahamudulhassan/"}
                  target="_blank"
                >
                  <Image
              ...
              <div className="flex h-10 w-10 items-center justify-center rounded-md border border-gray-200 p-1.5 transition-all duration-300 ease-in-out hover:bg-gray-100 hover:shadow-lg">
                <Link
                  href={"https://www.github.com/MahmudSoftware"}
                  target="_blank"
                >
                  <Image
              ...
              <div className="flex h-10 w-10 items-center justify-center rounded-md border border-gray-200 p-1.5 transition-all duration-300 ease-in-out hover:bg-gray-100 hover:shadow-lg">
                <Link
                  href={"https://www.facebook.com/MahmudSoftware"}
                  target="_blank"
                >
                  <Image
              ...
              <div className="flex h-10 w-10 items-center justify-center rounded-md border border-gray-200 p-1.5 transition-all duration-300 ease-in-out hover:bg-gray-100 hover:shadow-lg">
                <Link
                  href={"https://www.instagram.com/MahmudSoftware"}
                  target="_blank"
                >
                  <Image
